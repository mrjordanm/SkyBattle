...
class EntityFactory:
    ...
    def get_entity(entity_name: str):
        match entity_name:
            ...
            case 'Level3Bg':
                list_bg = []
                for i in range(4):  # quantidade de imagens do background do level 2 na pasta asset
            ...
            case 'Enemy1':
                return Enemy('Enemy1', (WIN_WIDTH + 10, random.randint(10, WIN_HEIGHT - 55)))
            case 'Enemy2':
                return Enemy('Enemy2', (WIN_WIDTH + 10, random.randint(10, WIN_HEIGHT - 55)))
            case 'Enemy3':
                return Enemy('Enemy3', (WIN_WIDTH + 10, random.randint(10, WIN_HEIGHT - 55)))
